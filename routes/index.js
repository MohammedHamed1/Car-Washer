...
const washRoutes = require('../modules/wash/wash.routes');
const packageRoutes = require('../modules/package/package.routes');
const userPackageRoutes = require('../modules/package/userPackage.routes');
const paymentRoutes = require('../modules/payment/payment.routes');
const feedbackRoutes = require('../modules/feedback/feedback.routes');
const washingPlaceRoutes = require('../modules/washingPlace/washingPlace.routes');
const notificationRoutes = require('../modules/feedback/notification.routes');
const referralRoutes = require('../modules/user/referral.routes');
...
router.get("/", (req, res) => {
  res.json({
    ...
    availableEndpoints: [
      ...
      "/users/login",
      "/users/profile",
      "/users/phone-signup-initiate",
      "/users/phone-signup-verify",
      "/users/phone-login-initiate",
      "/users/phone-login-verify",
      "/users/send-otp",
      "/users/verify-otp",
      "/users/referral-link",
      "/users/accept-referral",
      "/users/reward-referral",
      "/users/referral-status",
      "/users/barcodes",
      ...
      "/washing-places",
      "/washing-places/nearest",
      "/washing-places/:id",
      "/washing-places/:id/feedbacks",
      ...
      // User package routes
      "/user-packages",
      "/user-packages/active",
      "/user-packages/stats",
      "/user-packages/:id",
      "/user-packages/:id/use-wash",
      ...
      "/feedbacks",
      "/feedbacks/:id",
      "/feedbacks/washingPlace/:washingPlaceId",
      "/feedbacks/for-wash"
    ]
  });
});
...
router.use('/washes', washRoutes);
router.use('/packages', packageRoutes);
router.use('/user-packages', userPackageRoutes);
router.use('/payments', paymentRoutes);
router.use('/feedbacks', feedbackRoutes);
router.use('/washing-places', washingPlaceRoutes);
